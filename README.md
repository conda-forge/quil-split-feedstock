...
pixi add quil quil-cli quil-py quil_cli quil_py
# for installing globally
pixi global install quil quil-cli quil-py quil_cli quil_py
```
...
It is possible to list all of the versions of `quil` available on your platform:
...
```
pixi search quil --channel conda-forge
```
